var QueryLoader = {
	...
	spawnLoader: function() {
		...
		if (getCookie('url') != '') {
			$(QueryLoader.overlay).css('visibility', 'hidden');
		}
		...
		if (getCookie('url') != '') {
			$(QueryLoader.loadBar).css('visibility', 'hidden');
		}
		...
		if (getCookie('url') != '') {
			$(QueryLoader.loadAmt).css('visibility', 'hidden');
		}
	},
	...
	doneLoad: function() {
		...
		$('#pages').css('display','');
		$('.progress-region').css('display','');
		$('.progress-count').css('display','');
